...
@section('title', 'Tambah Owner - iManagement')
                ...
                <div class="w-full space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-4 lg:p-6 flex-1">
                            <h2 class="text-xl lg:text-2xl font-bold text-gray-800 flex items-center gap-3">
                                ...
                                <span class="truncate">Tambah Owner Baru</span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex gap-3 justify-end">
                            <a href="{{ route('admin.users.index') }}"
                                class="px-4 lg:px-6 py-2.5 lg:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition font-semibold text-sm lg:text-base">
                                <i class="fa-solid fa-xmark mr-1"></i> Batal
                            </a>
                            <button type="submit"
                                class="px-4 lg:px-6 py-2.5 lg:py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:shadow-xl transition font-semibold text-sm lg:text-base">
                                <i class="fa-solid fa-floppy-disk mr-1"></i> Simpan Owner
                            </button>
                        </div>
                    </form>
                </div>
