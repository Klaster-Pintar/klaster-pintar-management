...
@section('title', 'Tambah Marketing Mapping')
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl lg:text-2xl font-bold text-gray-800 flex items-center gap-2">
                                <i class="fa-solid fa-plus-circle text-pink-600"></i>
                                Tambah Marketing Mapping
                            </h1>
                            <p class="text-sm text-gray-600 mt-1">Mapping marketing dengan cluster untuk komisi</p>
                        </div>
                    </div>

                    <!-- Form -->
                    <div class="bg-white rounded-xl shadow-md p-6">
                        <form id="mappingForm" action="{{ route('admin.affiliate.mapping.store') }}" method="POST" onsubmit="return confirmSave(event)">
                            @csrf
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                                        Marketing <span class="text-red-500">*</span>
                                    </label>
                                    <select name="marketing_id" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 @error('marketing_id') border-red-500 @enderror">
                                ...
                                <div>
                                    ...
                                    <select name="cluster_id" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 @error('cluster_id') border-red-500 @enderror">
                                ...
                                <div class="bg-pink-50 border-l-4 border-pink-500 rounded-lg p-4">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="commission_percentage" value="{{ old('commission_percentage', 0) }}" 
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="commission_amount" value="{{ old('commission_amount', 0) }}" 
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" rows="3"
                                        ...
                                        placeholder="Catatan tambahan untuk mapping ini...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
                                    <button type="submit"
                                        ...
                                        <i class="fa-solid fa-save mr-1"></i> Simpan Mapping
                                    </button>
                                    <a href="{{ route('admin.affiliate.mapping.index') }}"
