...
class MarketingController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->back()
                ->withInput()
                ->with('error', 'Gagal menambahkan marketing: ' . $e->getMessage());
        }
    }
    ...
    public function update(Request $request, Marketing $marketing)
    {
        try {
            ...
            return redirect()->back()
                ->withInput()
                ->with('error', 'Gagal mengupdate marketing: ' . $e->getMessage());
        }
    }
    ...
    public function destroy(Marketing $marketing)
    {
        try {
            ...
            return redirect()->route('admin.affiliate.marketing.index')
                ->with('error', 'Gagal menghapus marketing: ' . $e->getMessage());
        }
    }
}
